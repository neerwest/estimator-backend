...
module.exports = function(Component) {
    ...
    Component.disableRemoteMethodByName("exists");
    Component.disableRemoteMethodByName('prototype.__get__project');
    Component.disableRemoteMethodByName('prototype.__get__teams__component');
    Component.disableRemoteMethodByName('prototype.__get__teams__project');
